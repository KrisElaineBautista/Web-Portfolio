...
const githubIcon = (
  <svg height="18" width="18" viewBox="0 0 24 24" fill="currentColor" style={{ verticalAlign: 'middle', marginRight: '0.3rem' }} aria-hidden="true">
...
const Footer = () => (
  <footer style={{
    ...
    background: 'var(--footer-bg)',    /* Logic: Use border color for footer bg */
    ...
    <div style={{ 
      ...
      <div style={{ display: 'flex', gap: '1.5rem' }}>
        <a
          ...
          target="_blank"
          rel="noreferrer"
          className="footer-link" /* We'll use a class for the hover color instead of inline */
          style={{ 
              textDecoration: 'none', 
              color: 'var(--text)', 
              display: 'flex', 
        ...
        <a
          href="https://www.linkedin.com/in/kriselainesbautista/"
          target="_blank"
          rel="noreferrer"
